...
public class FridgeRepository {
    ...
    private static LiveData<FridgeItem> getUserFridgeItemsFor(Pair<String, Beer> input) {
    ...
    public LiveData<List<Pair<FridgeItem, Beer>>> getMyFridgeItemsWithBeers(LiveData<String> currentUserId,
    ...
    public LiveData<FridgeItem> getMyFridgeItemForBeer(LiveData<String> currentUserId, LiveData<Beer> beer) {
        return switchMap(combineLatest(currentUserId, beer), FridgeRepository::getUserFridgeItemsFor);
    }
