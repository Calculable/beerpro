...
public class MainViewModel extends ViewModel implements CurrentUser {
    ...
    private final LiveData<List<MyBeerFromUser>> myBeers;
    ...
    public MainViewModel() {
        ...
        myFridgeItems = fridgeRepository.getMyFridgeItems(currentUserId);
    ...
    public LiveData<List<MyBeerFromUser>> getMyBeers() {
        return myBeers;
    }
